...
@click.command(help="")
@click.option("--log-dir", type=str, help="logging directory (contains checkpoint.pth)")
@click.option("--output-dir", type=str, default=None, help="output directory for colorized images")
...
@click.option('--local-rank', '--local_rank', 'local_rank', type=int, default=0)
@click.option('--only_test', type=bool, default=True)
@click.option('--add_mask', type=bool, default=True)
@click.option('--partial_finetune', type=bool, default=False)
@click.option('--add_l1_loss', type=bool, default=True)
@click.option('--l1_weight', type=float, default=10)
@click.option('--color_position', type=bool, default=True)
@click.option('--change_mask', type=bool, default=False)
@click.option('--color_as_condition', type=bool, default=False)
@click.option('--multi_scaled', type=bool, default=False)
@click.option('--downchannel', type=bool, default=False)
@click.option('--add_conv', type=bool, default=True)
@click.option('--before_classify', type=bool, default=False)
@click.option('--l1_conv', type=bool, default=True)
@click.option('--l1_linear', type=bool, default=False)
@click.option('--add_fm', type=bool, default=False)
@click.option('--fm_weight', type=float, default=1)
@click.option('--add_edge', type=bool, default=False)
@click.option('--edge_loss_weight', type=float, default=0.05)
@click.option('--mask_l_num', type=int, default=4)
@click.option('--n_blocks', type=int, default=1)
